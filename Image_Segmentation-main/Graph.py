...
class Graph(object):
    def __init__(self, image_path, neighborhood_8=True, min_size=250):
    ...
    def diff(self, node1, node2):
        ...
        grey1 = value1[0] * 0.1140 + value1[1] * 0.5870 + value1[2] * 0.2989
        grey2 = value2[0] * 0.1140 + value2[1] * 0.5870 + value2[2] * 0.2989
        # result = (grey1 - grey2) ** 2
    ...
    def random_color(self, i):
        ...
        color_table = [(255, 192, 203), (128, 0, 128), (106, 90, 205), (0, 0, 255), (135, 206, 235), (0, 128, 0),
                       (189, 183, 107), (255, 215, 0), (255, 0, 0), (0, 0, 0),
                       (123, 104, 238), (65, 105, 225), (0, 100, 0), (255, 255, 0), ]
        result = color_table[i % 14]
        return result
...
if __name__ == '__main__':
    ...
    answer = Graph(image_path=image_path)
    show_image(answer.segmented_image)
